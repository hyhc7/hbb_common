...
lazy_static::lazy_static! {
  ...
  //添加内置固定密码‘Phichem@it’
	pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
		...
		map.insert("password".to_string(), "Phichem@it".to_string());
		RwLock::new(map)
	};
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.phichem.com.cn"];
pub const RS_PUB_KEY: &str = "dl8Lbk+87gIeqeCxwcaKzvfRstqYQeuLyMQlxyfzzUk=";
